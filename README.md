...
- The folder `jrcai_corekit` is a set of python utiliites developed internally in the center (by Eng. Raed Mughaus) to make interactions with LLMs either on inference or tuning much easier.
